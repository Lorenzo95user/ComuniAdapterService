...
import dev.archety.project.models.CodeCapId;
import dev.archety.project.models.Comune;
import dev.archety.project.repositories.ComuneRepository;
...
public class ComuneService {
	...
	public List<String> getSiglaProvByDenominazione(String nome) {
		try {
			log.debug("Cerco la sigla Provincia del Comune {}",nome);
			List<String> str = repo.findSiglaProvinciaByDenominazioneIta(nome);
			if(str.isEmpty()) {
